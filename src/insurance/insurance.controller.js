...
var InsuranceController = /** @class */ (function () {
    ...
    InsuranceController.prototype.getInsuranceRisk = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.insuranceService.getInsuranceRisk(body)];
            });
        });
    };
    __decorate([
        (0, common_1.Patch)('/risk'),
        __param(0, (0, common_1.Body)())
    ], InsuranceController.prototype, "getInsuranceRisk");
